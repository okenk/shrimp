...
```{r}
#| label: fig-areas
#| fig-cap: "Revenue-per-recruit as a function of fishing mortality rates for each state area, from Northern California (18, upper left) to the Canadian border (32, bottom right). The dotted vertical lines are at the low and high range of estimated fishing mortality in the fishery. See supplement for a map of the state areas."
#| fig-dpi: 200
...
```{r}
#| label: fig-area-year
#| fig-cap: "Revenue-per-recruit as a function of fishing mortality rates for the state areas with the smallest (32) and largest (19) size-at-recruitment and in the years with the smallest (2012) and largest (2020) sizes-at-recruitment coastwide. Dotted lines are at the low and high range of estimated fishing mortality in the fishery. See supplement for a map of state areas."
